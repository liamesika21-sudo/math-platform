...
topics.push(
  ...
  },
  {
    ...
    courseId: 'data-structures',
    weekId: 'ds-w1',
    title: 'Linux/Unix — מערכת קבצים והרשאות',
    summary: 'ניווט במערכת הקבצים של Linux, פקודות cd/ls/cp/mv/chmod, הרשאות קבצים בייצוג אלפביתי ואוקטלי.',
    patterns: ['mkdir / cp / mv / rm', 'chmod — alphabetic & octal', 'הרשאות קבצים', 'echo / source'],
  },
);
...
sourceDocuments.push(
  ...
  },
  {
    ...
    weekId: 'ds-w1',
    type: 'tutorial',
    name: 'תרגול 1 — Linux/Unix: מערכת קבצים, פקודות והרשאות',
    topicIds: ['ds-w1-linux'],
    processed: true,
  },
);
...
weeks.push({
  ...
  topicIds: ['ds-w1-intro', 'ds-w1-adt', 'ds-w1-linked-lists', 'ds-w1-linux'],
  lectureItemIds: [
    'ds-w1-def-algorithm',
  ...
  tutorialQuestionIds: [
    'ds-w1-t1-q1', 'ds-w1-t1-q2', 'ds-w1-t1-q3', 'ds-w1-t1-q4', 'ds-w1-t1-q5',
    'ds-w1-t1-q6', 'ds-w1-t1-q7', 'ds-w1-t1-q8', 'ds-w1-t1-q9', 'ds-w1-t1-q10',
  ],
  homeworkQuestionIds: [],
  examQuestionIds: [],
  reviewHighlights: [
...
export const questions: PlatformQuestion[] = [
  ...
  // ─── Data Structures Week 1 — Tutorial 1 (Linux/Unix) ──────────────────────
  {
    id: 'ds-w1-t1-q1',
    courseId: 'data-structures',
    weekId: 'ds-w1',
    ...
    content:
      'צרו תת-תיקייה בשם dir1 בתוך התיקייה הנוכחית.\n\nכתבו את הפקודה המתאימה.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 2,
    title: 'העתקת תיקייה (recursive cp)',
    content:
      'העתיקו את תוכן התיקייה /share/recitations/recitation01 אל תוך dir1 שיצרתם.\n\nלאחר הפעולה, dir1 אמורה להכיל:\n- קובץ some_file.txt\n- תיקייה subdir המכילה שני קבצים\n\nשימו לב: יש להשתמש בנתיב יחסי ל-dir1 ובנתיב מוחלט למקור.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 3,
    title: 'שכפול תיקייה — cp -r',
    content:
      'צרו עותק של dir1 בשם dir2.\n\nאיזה flag נדרש כדי להעתיק תיקייה שלמה כולל תוכנה?',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  ...
  },
  {
    ...
    title: 'העברת קובץ — mv',
    content:
      'הזיזו את הקובץ myfile מתוך תיקייה subdir אל התיקייה הנוכחית (dir2).\n\nשימוש: השתמשו בנתיב יחסי. מה ההבדל בין cp ל-mv?',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 6,
    title: 'שינוי שם קובץ — mv',
    content:
      'שנו את שמו של הקובץ hello.world שנמצא ב-subdir לשם hello (ללא סיומת).\n\nרמז: mv משמשת גם לשינוי שם — הסבירו כיצד.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 7,
    title: 'הוספת הרשאת כתיבה — alphabetic chmod',
    content:
      'הוסיפו הרשאת כתיבה לעצמכם ולקבוצה שלכם עבור כל הקבצים בתיקייה הנוכחית ותת-תיקיותיה.\n\nדרישות:\n- השתמשו ב-alphabetic permission specifier (לא אוקטלי)\n- הפעילו רקורסיבית על כל הקבצים\n\nרמז: חשבו אילו אותיות מייצגות user, group, ואת הפעולה להוסיף הרשאה.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Important'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 8,
    title: 'הגדרת הרשאות — octal chmod',
    content:
      'שנו את ההרשאות של הקובץ myfile כך ש:\n- כל המשתמשים (אתם, הקבוצה, אחרים) יש להם הרשאת קריאה\n- רק אתם והקבוצה יש להם הרשאת כתיבה\n- רק אתם יש לכם הרשאת הרצה\n\nהשתמשו ב-octal mode.\n\nרמז: כל ספרה אוקטלית = 3 ביטים (r=4, w=2, x=1). חשבו מה ערך כל קבוצה.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 9,
    title: 'מחיקת תיקייה — rm',
    content:
      'מחקו את תת-התיקייה subdir מהתיקייה הנוכחית (dir2).\n\nאיזה flag נדרש למחיקת תיקייה שאינה ריקה? מה ההבדל בין rm לרגיל?',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
  },
  {
    ...
    sourceDocumentId: 'ds-w1-tutorial1',
    sourcePage: 10,
    title: 'הוספת שורה לקובץ — echo append',
    content:
      'השתמשו ב-echo כדי להוסיף (append) שורה עם הטקסט Hello world (ללא מרכאות) לקובץ myfile.\n\nלאחר הפעולה, myfile אמור להכיל בדיוק שתי שורות.\n\nרמז: מה ההבדל בין > ל->> ב-shell?',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
