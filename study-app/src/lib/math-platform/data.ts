...
sourceDocuments.push(
  ...
  },
  {
    ...
    weekId: 'logic-w2',
    type: 'homework',
    name: 'תרגיל 2 — עוצמות, פונקציות וקבוצות אינסופיות',
    topicIds: ['logic-w2-cardinality', 'logic-w2-functions', 'logic-w2-finite-infinite'],
    processed: true,
  },
);
...
weeks.push(
  {
    ...
    homeworkQuestionIds: [
      'logic-w2-hw2-q1a', 'logic-w2-hw2-q1b',
      'logic-w2-hw2-q2a', 'logic-w2-hw2-q2b',
      'logic-w2-hw2-q3a', 'logic-w2-hw2-q3b', 'logic-w2-hw2-q3c',
      'logic-w2-hw2-q4',
      'logic-w2-hw2-q5a', 'logic-w2-hw2-q5b', 'logic-w2-hw2-q5c',
      'logic-w2-hw2-q6a', 'logic-w2-hw2-q6b',
    ],
    examQuestionIds: [],
    reviewHighlights: [
...
sourceDocuments.push(
  ...
  },
  {
    ...
    weekId: 'ds-w1',
    type: 'homework',
    name: 'שיעורי בית 1 — יסודות מתמטיים, אינדוקציה ורשימות מקושרות',
    topicIds: ['ds-w1-intro', 'ds-w1-linked-lists'],
    processed: true,
  },
);
...
weeks.push({
  ...
  homeworkQuestionIds: [
    'ds-w1-hw1-qa1', 'ds-w1-hw1-qa2', 'ds-w1-hw1-qa3',
    'ds-w1-hw1-qb1', 'ds-w1-hw1-qb2a', 'ds-w1-hw1-qb2b',
    'ds-w1-hw1-qc1', 'ds-w1-hw1-qc2', 'ds-w1-hw1-qc3',
    'ds-w1-hw1-qd',
  ],
  examQuestionIds: [],
  reviewHighlights: [
...
sourceDocuments.push(
  ...
  },
  {
    ...
    weekId: 'ds-w2',
    type: 'homework',
    name: 'שיעורי בית 2 — Amortized Analysis, Stack via Queues, Min-Heap',
    topicIds: ['ds-w2-amortized', 'ds-w2-priority-queue', 'ds-w2-trees'],
    processed: true,
  },
);
...
weeks.push({
  ...
  homeworkQuestionIds: [
    'ds-w2-hw2-qa1', 'ds-w2-hw2-qa2',
    'ds-w2-hw2-qb',
    'ds-w2-hw2-qc1', 'ds-w2-hw2-qc2', 'ds-w2-hw2-qc3', 'ds-w2-hw2-qc4', 'ds-w2-hw2-qc5',
    'ds-w2-hw2-qd1', 'ds-w2-hw2-qd2',
  ],
  examQuestionIds: [],
  reviewHighlights: [
...
export const questions: PlatformQuestion[] = [
  ...
  // ─── Data Structures Week 1 — Homework 1 ───────────────────────────────────
  {
    id: 'ds-w1-hw1-qa1',
    courseId: 'data-structures',
    weekId: 'ds-w1',
    topicId: 'ds-w1-intro',
    sourceType: 'homework',
    sourceName: 'שיעורי בית 1',
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 2,
    title: 'A1: פתרון משוואה לוגריתמית',
    content: 'מצאו את הערך המדויק של x המקיים את המשוואה הלוגריתמית הבאה. הראו את השלבים:\n\nlog₂(x) + log₄(x) + log₈(x) = 11',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
    hint: 'המירו את כל הלוגריתמים לבסיס 2 באמצעות נוסחת החלפת בסיס: logₐ(x) = log₂(x)/log₂(a). כך log₄(x) = log₂(x)/2 ו-log₈(x) = log₂(x)/3.',
  },
  {
    id: 'ds-w1-hw1-qa2',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 2,
    title: 'A2: חישוב סכום עם חזקות של 2',
    content: 'נניח ש-n הוא חזקה של 2 (n = 2ᵏ עבור שלם k ≥ 1). חשבו את הסכום הבא ובטאו את התשובה כפונקציה מפושטת של n:\n\n∑(i=0 עד log₂n - 1) n/2ⁱ',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'זוהי טור הנדסי! הוציאו את n החוצה ותקבלו n·∑(1/2)ⁱ. השתמשו בנוסחה לסכום טור הנדסי סופי: ∑(i=0 עד m) rⁱ = (1-r^(m+1))/(1-r).',
  },
  {
    id: 'ds-w1-hw1-qa3',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 2,
    title: 'A3: פישוט ביטוי אקספוננציאלי-לוגריתמי',
    content: 'פשטו את הביטוי 2^(log₄ x) לביטוי ללא מעריכים או לוגריתמים כפונקציה חיצונית. הראו את השלבים.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
    hint: 'השתמשו בהחלפת בסיס: log₄(x) = log₂(x)/2. אז 2^(log₄ x) = 2^(log₂(x)/2). מה זה 2^(1/2)?',
  },
  {
    id: 'ds-w1-hw1-qb1',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 2,
    title: 'B1: הוכחה באינדוקציה — מודל התפשטות מגפה',
    content: 'מודל התפשטות מגפה: ביום d=1 בדיוק אדם אחד (Patient Zero) נדבק. כל אדם שנדבק ביום d ידביק לכל היותר 2 אנשים חדשים ביום d+1 (ואז מחלים ולא מדביקים יותר).\n\nהוכיחו באינדוקציה על d שהמספר המקסימלי של נדבקים חדשים ביום d הוא לכל היותר 2^(d-1).',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'בסיס: d=1, נדבק אחד = 2⁰ = 1. צעד: ביום d+1, כל אחד מלכל היותר 2^(d-1) הנדבקים של יום d מדביק לכל היותר 2 חדשים. מה המכפלה?',
  },
  {
    id: 'ds-w1-hw1-qb2a',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 2,
    title: 'B2a: בדיקת הוכחת אינדוקציה — "כל n נקודות על ישר"',
    content: 'טענה: בהינתן n ≥ 2 נקודות במישור, כולן נמצאות על אותו ישר.\n\nבדקו אם ההוכחה באינדוקציה הבאה נכונה או לא:\n- בסיס: n=2, התביעה מתקיימת.\n- הנחה: מתקיים ל-n.\n- צעד: עבור n+1 נקודות, מפעילים את ההנחה על p₁...pₙ (ישר ℓ₁) ועל p₂...pₙ₊₁ (ישר ℓ₂). מכיוון ש-ℓ₁ ו-ℓ₂ חולקים את p₂...pₙ, מסיקים ℓ₁=ℓ₂.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'ההוכחה שגויה! חשבו מה קורה במעבר מ-n=2 ל-n=3. כשיש רק 3 נקודות, כמה נקודות משותפות יש בין שתי תת-הקבוצות בגודל 2? האם זה מספיק כדי להסיק ש-ℓ₁=ℓ₂?',
  },
  {
    id: 'ds-w1-hw1-qb2b',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 3,
    title: 'B2b: בדיקת הוכחת אינדוקציה — חסם רקורסיבי T(n) ≤ 10n log₂ n',
    content: 'טענה: בהינתן T(2)=4 ו-T(n) ≤ 2T(n/2)+10n עבור n=2ᵏ, מתקיים T(n) ≤ 10n log₂ n.\n\nבדקו אם ההוכחה הבאה באינדוקציה נכונה:\n- בסיס: k=1, T(2)=4 ≤ 20.\n- הנחה: T(n/2) ≤ 10·(n/2)·log₂(n/2).\n- צעד: T(n) ≤ 2·10·(n/2)·log₂(n/2) + 10n = 10n(log₂(n/2)+1) = 10n·log₂n.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'עקבו אחרי כל שלב אלגברי. שימו לב ש-log₂(n/2) = log₂(n) - 1, ולכן log₂(n/2) + 1 = log₂(n). האם כל הצעדים חוקיים?',
  },
  {
    id: 'ds-w1-hw1-qc1',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 3,
    title: 'C1: הוכחה באינדוקציה — n! > 2ⁿ לכל n ≥ 4',
    content: 'הוכיחו באינדוקציה: לכל n ≥ 4 מתקיים n! > 2ⁿ.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'בסיס: n=4, בדקו ש-4!=24 > 2⁴=16. צעד: (n+1)! = (n+1)·n! > (n+1)·2ⁿ. למה (n+1)·2ⁿ ≥ 2·2ⁿ = 2ⁿ⁺¹ כאשר n ≥ 4?',
  },
  {
    id: 'ds-w1-hw1-qc2',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 3,
    title: 'C2: הוכחה באינדוקציה — סכום i·2ⁱ',
    content: 'הוכיחו באינדוקציה: לכל n חיובי מתקיים\n∑(i=2 עד n) i·2ⁱ = 2ⁿ⁺¹(n-1).',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'צעד האינדוקציה: ∑(i=2 עד n+1) i·2ⁱ = ∑(i=2 עד n) i·2ⁱ + (n+1)·2ⁿ⁺¹. השתמשו בהנחה להחליף את הסכום ב-2ⁿ⁺¹(n-1) ופשטו.',
  },
  {
    id: 'ds-w1-hw1-qc3',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 3,
    title: 'C3: הוכחת נכונות Binary Search באינדוקציה',
    content: 'הוכיחו באינדוקציה את נכונות אלגוריתם Binary Search:\n\nBSearch(x, A, i, j):\n  if j-i < 0: return -1\n  m ← ⌊(i+j)/2⌋\n  if x = A[m]: return m\n  else if x < A[m]: return BSearch(x, A, i, m-1)\n  else: return BSearch(x, A, m+1, j)\n\nהוכיחו שבהינתן ערך x ומערך ממוין A, הקריאה מחזירה אינדקס m כך ש-A[m]=x, או -1 אם x לא במערך. האינדוקציה על גודל הקטע n=j-i+1.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'בסיס: n=0 (j-i<0), הקטע ריק ומוחזר -1. צעד: הניחו שהאלגוריתם נכון לכל קטע בגודל < n. כשהקטע בגודל n, שורה 5-6 מטפלת במקרה שנמצא. אחרת, הקריאה הרקורסיבית על קטע קטן יותר — השתמשו בהנחת האינדוקציה.',
  },
  {
    id: 'ds-w1-hw1-qd',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w1-hw1',
    sourcePage: 4,
    title: 'D: היפוך רשימה מקושרת יחידה ב-O(n) זמן ו-O(1) מקום',
    content: 'תכננו אלגוריתם שמקבל רשימה מקושרת יחידה עם n איברים ומהפך את סדר האיברים (הראשון הופך לאחרון והאחרון לראשון).\n\n1. כתבו פסאודוקוד. ניתן להניח שלכל איבר יש שדות next ו-value ויש גישה ל-L.head.\n\n2. נתחו את סיבוכיות הזמן והמקום. לציון מלא: O(n) זמן ו-O(1) מקום עזר בלבד (בלי העתקה למערך, מבנה נוסף או רקורסיה).',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'השתמשו ב-3 מצביעים: prev, curr, next. בכל איטרציה: שמרו את curr.next ב-next, הפנו את curr.next ל-prev, קדמו prev=curr ו-curr=next. בסוף, L.head = prev.',
  },
  ...
  // ─── Data Structures Week 2 — Homework 2 ───────────────────────────────────
  {
    id: 'ds-w2-hw2-qa1',
    courseId: 'data-structures',
    weekId: 'ds-w2',
    topicId: 'ds-w2-amortized',
    sourceType: 'homework',
    sourceName: 'שיעורי בית 2',
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 2,
    title: 'A1: ניתוח Amortized — מונה טרנרי (בסיס 3)',
    content: 'מונה בבסיס 3 (ternary) מורכב ממערך ספרות D[0..k-1] כאשר D[i] ∈ {0,1,2}. המונה מתחיל מ-0. בכל Increment, הספרה D[0] גדלה ב-1. אם מגיעה ל-3, מתאפסת ל-0 והספרה הבאה D[1] גדלה, וכך הלאה.\n\nמהי העלות ה-amortized של פעולת Increment בודדת כשסופרים מ-0 עד n? הניחו ששינוי ספרה בודדת עולה יחידת עבודה אחת. הראו ניתוח מתמטי.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'חשבו על כמה פעמים כל ספרה משתנה: D[0] משתנה בכל increment, D[1] משתנה כל 3 פעמים, D[2] כל 9 פעמים... סכמו את הטור הגאומטרי ∑ n/3ⁱ.',
  },
  {
    id: 'ds-w2-hw2-qa2',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 2,
    title: 'A2: מונה בינארי משוקלל — עלות Amortized',
    content: 'מונה בינארי רגיל, אבל עלות היפוך הביט ה-i (כש-i=0 הוא ה-LSB) היא בדיוק 2ⁱ יחידות עבודה.\n\nמהי העלות ה-amortized של פעולת Increment בודדת כשסופרים מ-0 עד n? בטאו בסימון Big-O.\n\nהנחיה: השתמשו בעובדה שצריך לכל היותר k = ⌈log₂(n)⌉ ביטים, וכתבו את סכום העבודה הכולל.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'ביט i מתהפך ⌊n/2ⁱ⌋ פעמים, וכל היפוך עולה 2ⁱ. העלות הכוללת לביט i: (n/2ⁱ)·2ⁱ = n. יש k ≈ log₂(n) ביטים. מה הסכום הכולל?',
  },
  {
    id: 'ds-w2-hw2-qb',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 2,
    title: 'B: מימוש Stack באמצעות שתי Queues',
    content: 'ממשו Stack (LIFO) באמצעות בדיוק שתי תורים Q₁ ו-Q₂.\n\n1. תארו את האלגוריתמים Push(x) ו-Pop() באמצעות Q₁ ו-Q₂. (ה-Pop צריך להיות הפעולה היקרה).\n\n2. נתחו את הסיבוכיות worst-case ו-amortized של Push ו-Pop.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'Push: פשוט הכניסו ל-Q₁ ב-O(1). Pop: העבירו את כל האיברים מ-Q₁ ל-Q₂ חוץ מהאחרון — הוא התוצאה. אז החליפו שמות בין Q₁ ל-Q₂.',
  },
  {
    id: 'ds-w2-hw2-qc1',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'C1: טענה — מערך ממוין הוא Min-Heap חוקי',
    content: 'הוכיחו או הפריכו: אם A הוא מערך ממוין (בסדר לא-יורד), אז הוא מייצג Min-Heap חוקי.\n\n(אינדוקס 1-based: A[1] שורש, ילדי A[i] הם A[2i] ו-A[2i+1].)',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'חשבו: בMin-Heap, כל הורה קטן-שווה מילדיו. אם A ממוין, אז A[i] ≤ A[j] לכל j > i. בפרט, A[i] ≤ A[2i] ו-A[i] ≤ A[2i+1]. מה המסקנה?',
  },
  {
    id: 'ds-w2-hw2-qc2',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'C2: טענה — ייצוג Heap הוא תמיד מערך ממוין',
    content: 'הוכיחו או הפריכו: אם H הוא Min-Heap המיוצג על ידי מערך A, אז A הוא מערך ממוין.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'חפשו דוגמה נגדית! נסו heap קטן עם 3 איברים, למשל A = [1, 3, 2]. האם זה heap חוקי? האם זה ממוין?',
  },
  {
    id: 'ds-w2-hw2-qc3',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'C3: טענה — A[i] ≤ A[j] לכל j > 2i',
    content: 'הוכיחו או הפריכו: אם H הוא Min-Heap המיוצג על ידי A (A[1] שורש), אז לכל j > 2i מתקיים A[i] ≤ A[j].',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'j > 2i לא בהכרח אומר ש-j הוא צאצא של i. חפשו דוגמה נגדית: שרטטו heap עם 7 איברים ובדקו אם A[2] ≤ A[5] תמיד מתקיים (שימו לב ש-A[5] הוא ילד של A[2], אבל מה עם A[3] ו-A[7]?).',
  },
  {
    id: 'ds-w2-hw2-qc4',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'C4: טענה — A[1], A[2], A[4], ..., A[2^⌊log₂n⌋] ממוין',
    content: 'הוכיחו או הפריכו: אם H הוא Min-Heap עם n איברים, אז A[1], A[2], A[4], ..., A[2^⌊log₂n⌋] הוא סדרה ממוינת.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'שימו לב שהסדרה עוקבת אחרי המסלול מהשורש תמיד לילד השמאלי: A[1] → A[2] → A[4] → A[8] → ... כל איבר הוא הורה של הבא. מה תכונת ה-Heap מבטיחה?',
  },
  {
    id: 'ds-w2-hw2-qc5',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'C5: טענה — מיון כל רמה בנפרד שומר על חוקיות ה-Heap',
    content: 'הוכיחו או הפריכו: אם ממיינים כל רמה (כל הצמתים באותו עומק) ב-H בנפרד, אז H נשאר Min-Heap חוקי.\n\nהנחיה: ניתן להניח ש-H הוא עץ בינארי שלם. תהי רמה k עם m איברים x₁ ≤ x₂ ≤ ... ≤ xₘ לאחר מיון. הסתכלו על רמה k+1.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'לאחר מיון רמה k, xᵢ הוא האיבר ה-i בגודלו ברמה. לכל xᵢ יש 2 ילדים ברמה k+1. כמה איברים ברמה k+1 חייבים להיות ≥ xᵢ? (לפחות 2i איברים — 2 ילדים של כל xⱼ עבור j ≤ i). האם 2i ≤ 2m מספיק?',
  },
  {
    id: 'ds-w2-hw2-qd1',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'D1: מעקב הכנסות ל-Min-Heap',
    content: 'עקבו אחרי הכנסת הרצף הבא אחד-אחד ל-Min-Heap ריק:\n10, 12, 1, 14, 6, 5, 8\n\nהציגו את ייצוג המערך של ה-Heap אחרי כל שלב (הכנסה + percolate up) של כל 7 ההכנסות.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'הוסיפו כל איבר בסוף המערך ואז בצעו percolate-up: השוו עם ההורה (A[⌊i/2⌋]) והחליפו אם קטן ממנו. חזרו עד שההורה קטן-שווה או שהגעתם לשורש.',
  },
  {
    id: 'ds-w2-hw2-qd2',
    courseId: 'data-structures',
    ...
    sourceDocumentId: 'ds-w2-hw2',
    sourcePage: 3,
    title: 'D2: מעקב DeleteMin מ-Min-Heap',
    content: 'מה-Heap הסופי מחלק D1, בצעו שתי פעולות DeleteMin.\n\nהציגו את ייצוג המערך אחרי כל שלב בכל אחת משתי המחיקות.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'DeleteMin: העבירו את האיבר האחרון לשורש, ואז בצעו percolate-down: השוו עם הילד הקטן יותר והחליפו אם גדול ממנו. חזרו עד שההורה קטן-שווה משני ילדיו.',
  },
  ...
  // ─── Logic Week 2 — Homework 2 ─────────────────────────────────────────────
  {
    ...
    sourceType: 'homework',
    sourceName: 'תרגיל 2',
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '1א: אם A⊆B אז |A|≤|B|',
    content: 'תהיינה A, B קבוצות. הוכיחו: אם A ⊆ B אז |A| ≤ |B|.',
    difficulty: 'easy',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'הגדרת |A|≤|B| דורשת פונקציה חח"ע מ-A ל-B. אם A⊆B, איזו פונקציה טבעית היא חח"ע מ-A ל-B? חשבו על פונקציית הזהות/הכלה.',
  },
  {
    id: 'logic-w2-hw2-q1b',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '1ב: הוכיחו או הפריכו A×B∼B×A',
    content: 'תהיינה A, B קבוצות. הוכיחו או הפריכו: A × B ∼ B × A.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'נסו להגדיר f: A×B → B×A ע"י f(a,b) = (b,a). בדקו שזו bijection: האם היא חח"ע? האם היא על?',
  },
  {
    id: 'logic-w2-hw2-q2a',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '2א: הוכיחו ℤ×{3} ∼ ℤ×{3,4}',
    content: 'הוכיחו: ℤ × {3} ∼ ℤ × {3,4}.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'ℤ×{3} שקולה ל-ℤ, ו-ℤ×{3,4} שקולה ל-ℤ∪ℤ (שני עותקים של ℤ). הגדירו bijection שמפצלת את הזוגיים לעותק אחד ואת האי-זוגיים לעותק שני.',
  },
  {
    id: 'logic-w2-hw2-q2b',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '2ב: הוכיחו [0,1)×ℕ ∼ [1,∞)',
    content: 'הוכיחו: [0,1) × ℕ ∼ [1, ∞).',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'חשבו על הפונקציה f(x,n) = n + x. כל זוג (x,n) כש-x∈[0,1) ו-n∈ℕ נשלח ל-n+x∈[n, n+1). בדקו שזו bijection מ-[0,1)×ℕ על [0,∞), ואז התאימו ל-[1,∞).',
  },
  {
    id: 'logic-w2-hw2-q3a',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '3א: אם A∼B ו-C∼D, האם A△C ∼ B△D?',
    content: 'הוכיחו או הפריכו: אם A∼B ו-C∼D, אז A △ C ∼ B △ D.\n\n(A△C = הפרש סימטרי = (A∖C) ∪ (C∖A)).',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: false,
    systemTags: ['Must Know'],
    hint: 'חפשו דוגמה נגדית! נסו A={1,2}, B={3,4}, C={2,3}, D={1,4}. חשבו מה A∼B ו-C∼D, ובדקו האם |A△C| = |B△D|.',
  },
  {
    id: 'logic-w2-hw2-q3b',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '3ב: אם A×B ∼ A×C האם B∼C?',
    content: 'הוכיחו או הפריכו: אם A × B ∼ A × C אז B ∼ C.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'מה קורה כש-A=∅? אם A=∅ אז A×B=∅ ו-A×C=∅, אז ∅∼∅ תמיד, גם אם B ו-C שונים בגודלם.',
  },
  {
    id: 'logic-w2-hw2-q3c',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '3ג: אם A×B ∼ A×C וגם A≠∅ האם B∼C?',
    content: 'הוכיחו או הפריכו: אם A × B ∼ A × C וגם A ≠ ∅, אז B ∼ C.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'גם זה לא נכון בהכרח! חפשו דוגמה עם קבוצות אינסופיות: למשל A=ℕ, B=ℕ, C={0}. האם ℕ×ℕ ∼ ℕ×{0}? (שתיהן בני-מנייה, אבל...) חשבו היטב.',
  },
  {
    id: 'logic-w2-hw2-q4',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '4: הוכיחו אם A∼B ו-C∼D אז A×C ∼ B×D',
    content: 'הוכיחו: אם A∼B ו-C∼D, אז A × C ∼ B × D.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'אם f: A→B ו-g: C→D הן bijections, הגדירו h: A×C → B×D ע"י h(a,c) = (f(a), g(c)). הוכיחו ש-h היא bijection.',
  },
  {
    id: 'logic-w2-hw2-q5a',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '5א: |A|=|B|=|ℕ|, הוכיחו/הפריכו |A∪B|=|A|',
    content: 'תהיינה A, B קבוצות המקיימות |A| = |B| = |ℕ|.\nהוכיחו או הפריכו: |A ∪ B| = |A|.',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'A∪B ⊆ ? ובגלל ש-A ⊆ A∪B גם |A| ≤ |A∪B|. עכשיו הראו |A∪B| ≤ |ℕ| — הגדירו מיפוי: אלמנטים של A למספרים זוגיים, אלמנטים של B למספרים אי-זוגיים.',
  },
  {
    id: 'logic-w2-hw2-q5b',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '5ב: |A|=|B|=|ℕ|, הוכיחו/הפריכו |A∖B|≠|A|',
    content: 'תהיינה A, B קבוצות המקיימות |A| = |B| = |ℕ|.\nהוכיחו או הפריכו: |A ∖ B| ≠ |A|.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'חפשו דוגמה נגדית: למשל A=ℕ, B=הזוגיים. אז A∖B = האי-זוגיים, ו-|אי-זוגיים|=|ℕ|=|A|. אבל גם דוגמה שבה |A∖B|≠|A| (כמו A=B=ℕ, אז A∖B=∅).',
  },
  {
    id: 'logic-w2-hw2-q5c',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '5ג: |A|=|B|=|ℕ|, הוכיחו/הפריכו |A∩ℕ|=|B|',
    content: 'תהיינה A, B קבוצות המקיימות |A| = |B| = |ℕ|.\nהוכיחו או הפריכו: |A ∩ ℕ| = |B|.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'הטענה לא נכונה בהכרח! נסו A=ℝ (אם |ℝ|=|ℕ|? לא!). רגע — |A|=|ℕ|, אז A בת-מנייה. אם A∩ℕ סופית? למשל A = {√2+n : n∈ℕ}, אז A∩ℕ=∅...',
  },
  {
    id: 'logic-w2-hw2-q6a',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '6א: הוכיחו אם A∼B אז P(A)∼P(B)',
    content: 'הוכיחו: אם A∼B אז P(A) ∼ P(B).\n\n(P(A) = קבוצת החזקה של A = אוסף כל תתי-הקבוצות של A.)',
    difficulty: 'medium',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'תהי f: A→B bijection. הגדירו F: P(A)→P(B) ע"י F(S) = f(S) = {f(x) : x∈S} (התמונה של S תחת f). הוכיחו ש-F היא bijection — השתמשו בעובדה ש-f היא bijection.',
  },
  {
    id: 'logic-w2-hw2-q6b',
    courseId: 'logic',
    ...
    sourceDocumentId: 'logic-w2-hw2',
    sourcePage: 1,
    title: '6ב: הוכיחו אם A אינסופית אז P(A) אינסופית',
    content: 'הוכיחו בעזרת סעיף א׳ ובעזרת הגדרת קבוצה אינסופית: אם A אינסופית אז P(A) אינסופית.',
    difficulty: 'hard',
    isRequired: true,
    isExamFrequent: true,
    systemTags: ['Must Know', 'Frequently Appears in Exams'],
    hint: 'A אינסופית ⟹ קיימת B⊊A כך ש-A∼B. מסעיף א׳: P(A)∼P(B). עכשיו הראו ש-P(B)⊊P(A) (כי B⊊A). לכן P(A)∼P(B)⊊P(A), מה שאומר ש-P(A) אינסופית לפי ההגדרה.',
  },
