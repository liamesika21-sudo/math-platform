...
const courseTopics: Record<CourseId, string> = {
  logic:
    'לוגיקה פרופוזיציונית (טאוטולוגיות, כמתים, הוכחות), תורת הקבוצות (פעולות, חזקת הקבוצה), יחסים (שקילות, סדר), פונקציות (חד-חד-ערכיות, על, הרכבה), הוכחות (אינדוקציה, סתירה, ישירה).',
  'data-structures':
    'מערכים ורשימות מקושרות, מחסניות ותורים, עצים (בינאריים, BST, heap), גרפים (BFS, DFS), טבלאות גיבוב, מיון ואלגוריתמים בסיסיים, סיבוכיות זמן ומקום.',
};
