  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">תכנית לימוד מותאמת למבחן - 11 בפברואר 2026</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold">המבחן ביום רביעי, 11 בפברואר 2026</h2>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <h3 className="text-sm font-medium text-gray-700 mb-2">דטרמיננטות</h3>
            <div className="grid md:grid-cols-2 gap-2">
              {keyFormulas.determinants.map((f, i) => (
