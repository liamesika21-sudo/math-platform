        ...
        <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
          ...
          <div className="p-4 space-y-3">
            ...
            <div className="p-3 bg-purple-50 rounded-lg">
              <p className="font-medium text-purple-900">יום 3 - בסיס ומימד + סימולציית מבחן</p>
              <p className="text-sm text-purple-700">מבחן הכנה בתנאי אמת</p>
            </div>
            <div className="p-3 bg-green-50 rounded-lg">
              <p className="font-medium text-green-900">יום 4 - יום המבחן</p>
      ...
      <div className="bg-white rounded-xl border border-gray-100 shadow-sm">
        ...
        <div className="p-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
            ...
            {keyFormulas.determinants.slice(0, 1).map((f, i) => (
              <div key={`det-${i}`} className="p-3 bg-gray-50 rounded-lg border border-gray-100">
                <p className="font-mono text-sm text-gray-700">{f.formula}</p>
                <p className="text-xs text-gray-500 mt-1">{f.name}</p>
              </div>
            ))}
