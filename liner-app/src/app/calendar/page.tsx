  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500">תכנית לימודים עד ל-11 בפברואר 2026</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-red-500 to-orange-500 rounded-xl p-6 text-white">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <p className="text-red-100">11 בפברואר 2026</p>
          </div>
      ...
      <div className="bg-white rounded-xl border border-gray-100 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <span className="px-4 py-2 bg-indigo-100 text-indigo-700 rounded-lg font-medium">שבת 7.2</span>
          <span className="px-4 py-2 bg-blue-100 text-blue-700 rounded-lg font-medium">ראשון 8.2</span>
          <span className="px-4 py-2 bg-purple-100 text-purple-700 rounded-lg font-medium">שני 9.2</span>
          <span className="px-4 py-2 bg-green-100 text-green-700 rounded-lg font-medium">שלישי 10.2</span>
        </div>
      </div>
