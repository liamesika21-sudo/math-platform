      ...
      <div className="space-y-4">
        {activeTab === 'definitions' && (
          <div className="space-y-4">
            {week.definitions.length === 0 ? (
              <EmptyState message="אין הגדרות בשבוע זה" />
            ) : (
        ...
        {activeTab === 'formulas' && (
          <div className="space-y-4">
            ...
            {(!week.keyFormulas || week.keyFormulas.length === 0) && (!week.examTips || week.examTips.length === 0) && (
              <EmptyState message="אין נוסחאות בשבוע זה" />
            )}
          </div>
        )}
      </div>
